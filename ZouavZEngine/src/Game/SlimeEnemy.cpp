...
void SlimeEnemy::OnDeath()
{
	...
	{
		deathSlime->GetComponent<SlimeEnemy>()->lifeFont = deathSlime->GetComponent<FontComponent>();
		deathSlime->GetComponent<SlimeEnemy>()->lifeFont->ChangeText(std::to_string(maxLife - dividedCount));
	}
