...
static Quaternion QuaternionFromPxQuat(const physx::PxQuat& q) { return { q.w, q.x, q.y, q.z }; }
static physx::PxQuat PxQuatFromQuaternion(const Quaternion& q) { return { q.x, q.y, q.z, q.w }; }
...
static physx::PxTransform PxTransformFromTransform(const Transform& t) { return { PxVec3FromVec3(t.WorldPosition()), PxQuatFromQuaternion(t.WorldRotation()) }; }
